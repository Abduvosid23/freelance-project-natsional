                   ...
                   <div class="contact-form">
                       ...
                       <form action="{{ route('products.store')}}" method="POST" enctype="multipart/form-data" >
                          ...
                          <div class="control-group mb-4">
                               <input type="text" class="form-control p-4" name="title" value="{{old('title')}}" placeholder="Mahsulot nomi"  />
                               @error('title')
                           ...
                           <div class="control-group mb-4">
                            <input type="text" class="form-control p-4" name="price" value="{{old('price')}}" placeholder="Narxi"  />
                            @error('title')
                            <p class="help-block text-danger">{{ $message }}</p>
                            @enderror
                        </div>
