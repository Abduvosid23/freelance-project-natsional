            ...
            <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="w-100" src="img/paqir stanok.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                <h6 class="section-title text-white text-uppercase mb-3 animated slideInDown">Sifat Kafolati</h6>
                                <h1 class="display-3 text-white mb-4 animated slideInDown">Yangi tarkibdagi Mahsulotlar</h1>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Biz haqimizda </a>
                                <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Mahsulotalr </a>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img class="w-100" src="img/himikatlar.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                <h6 class="section-title text-white text-uppercase mb-3 animated slideInDown">Sifat Kafolarti</h6>
                                <h1 class="display-3 text-white mb-4 animated slideInDown">Dunyo standartlariga Mos</h1>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Biz Haqimizda </a>
                                <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Mahsulotlar </a>
                            </div>
                        </div>
                    </div>
                </div>
